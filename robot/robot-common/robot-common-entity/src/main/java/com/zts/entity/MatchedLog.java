...
public class MatchedLog implements Serializable {
    ...
    public MatchedLog(Integer companyId, String companyName, String userId, String userName, String input, String matchedType, String matchedId, String matchedName) {
