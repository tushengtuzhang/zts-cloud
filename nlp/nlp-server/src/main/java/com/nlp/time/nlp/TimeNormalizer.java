...
public class TimeNormalizer implements Serializable {
    ...
    private void preHandling() {
        // 清理空白符
        target = StringPreHandlingModule.delKeyword(target, "\\s+");
        // 清理语气助词
        target = StringPreHandlingModule.delKeyword(target, "[的]+");
        // 大写数字转化
